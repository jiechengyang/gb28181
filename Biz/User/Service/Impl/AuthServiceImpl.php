    ...
    protected function protectiveRule($type, $ip)
    {
        switch ($type) {
            case 'middle':
                ...
                $limiter = $factory('register.ip.mid_one_day', self::MID_IP_MAX_ALLOW_ATTEMPT_ONE_DAY, TimeMachineToolkit::ONE_DAY);
            ...
            case 'high':
                ...
                $dayLimiter = $factory('register.ip.high_one_day', self::HIGH_IP_MAX_ALLOW_ATTEMPT_ONE_DAY, TimeMachineToolkit::ONE_DAY);
                ...
                $hourLimiter = $factory('register.ip.high_one_hour', self::HIGH_IP_MAX_ALLOW_ATTEMPT_ONE_HOUR, TimeMachineToolkit::ONE_HOUR);
